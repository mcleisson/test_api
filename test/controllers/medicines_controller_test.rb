...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post medicines_url, params: { medicine: { name: @medicine.name, quantity: @medicine.quantity, stock: @medicine.stock, value: @medicine.value } }, as: :json
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { name: @medicine.name, quantity: @medicine.quantity, stock: @medicine.stock, value: @medicine.value } }, as: :json
    assert_response 200
  end
